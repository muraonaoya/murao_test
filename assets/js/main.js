 ...
 * <answer-input v-bind:correct="解答" v-on:answer-input="answerInput(stage, e, final)"></answer-input>
 * 解答：correctAnswer['stage1']['q1']
 * answerInput(stage, e, final)：
 *          stage：STAGE名 'stage1'
 *          e    ：問題番号（数字） 1
...
const app = Vue.createApp({
  ...
  methods: {
    /* 「送信」ボタンをクリックした時、正解だった場合の動作です。 */
    answerInput(stage, number, final) {
      /* answerをtrueにします。 */
      this.answer[stage][number-1] = true;
